...
@testset "Utilities" begin
    ...
    @testset "Normal to Marginal" begin
        ...
        @test_nowarn MvSim.normal_to_margin(D, x)
        @test_nowarn MvSim.normal_to_margin(D, y)
        @test_nowarn MvSim.normal_to_margin(D, z)

        @test_throws MethodError MvSim.normal_to_margin(D, ω)
        @test_throws MethodError MvSim.normal_to_margin(D, γ)
